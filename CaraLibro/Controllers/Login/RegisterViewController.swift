...
class RegisterViewController: UIViewController {
    ...
    @objc private func registerButtonTapped() {
        ...
        DatabaseManager.shared.userExists(with: email, completion: {[weak self]exists in
            ...
            guard !exists else {
                // user already exists
                strongSelf.alertUserLoginError(message: "El email ya existe")
                return
            }
    ...
    func alertUserLoginError(message: String = "Por favor ingresa toda la informacion para crear una nueva cuenta") {
...
extension RegisterViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate{
    ...
    func presentPhotoActionSheet(){
        ...
        actionSheet.addAction(UIAlertAction(title: "Escoger Foto",
                                            style: .cancel,
                                            handler: {[weak self]_ in
